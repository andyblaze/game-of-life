...
export default class View {
    ...
    radialGradientFill(ctx, site, hue, alpha) {
        ...
        g.addColorStop(1, `hsla(${hue},80%,80%,1)`);
    ...
    draw(data) {
        for ( let i = 0; i < data.cells.length; i++ ) {
            ...
            const { base, range, light, speed } = this.cfg.global("cyanglow");
            ...
            //this.noiseDrivenFill(this.offCtx, data.sites[i], cell, data.perlin, data.timestamp, this.cfg.global);
        }
