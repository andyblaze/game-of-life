...
export default class TransformMediator extends Animation {
    ...
    constructor(cnvs) {
        super(cnvs);
        this.plaintextUnderliner = new Underliner(cnvs, null, {"direction": "encrypt", "type": "plaintext", "stepTime": 3000, "holdTime": 200});
        this.alphabetUnderliner = new Underliner(cnvs, null, {"direction": "encrypt", "type": "alphabet", "stepTime": 300, "holdTime": 200});
        this.indicesUnderliner = new Underliner(cnvs, null, {"direction": "encrypt", "type": "indices", "stepTime": 300, "holdTime": 200});
